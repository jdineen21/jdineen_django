...
export default class Matrix extends React.Component {
    ...
    componentDidMount() {
        this.setState({ canvas: this.refs.canvas }, () => {
            ...
            let source = "アァカサタナハマヤャラワガザダバパイィキシチニヒミリヰギジヂビピウゥクスツヌフムユュルグズブヅプエェケセテネヘメレヱゲゼデベペオォコソトノホモヨョロヲゴゾドボポヴッン";
    ...
    render() {
        return (
            <div id="canvas_wrapper" style={{background: '#000000', width: '100vw', overflow: 'hidden'}}>
                <canvas id="matrix_canvas" ref='canvas'/>
            </div>
        );
    }
}